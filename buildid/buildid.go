// This is borrowed and modified from
// https://raw.githubusercontent.com/golang/go/4be4da6331b4acfc379113bd5603079a4f36741a/src/cmd/go/internal/buildid/buildid.go
...
func ReadBuildID(isProgram bool, target string) (id string, err error) {
	if isProgram {
